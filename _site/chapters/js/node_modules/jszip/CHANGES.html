...
<html>
  ...
  <meta name="description" content="Libro Eloquent JavaScript por Marijn Haverbeke
">
...
<ul>
  ...
  <div class="wrapper">
    ...
    <h2 class="footer-heading"><a href='about/' title="Acerca de">
    ...
    <div class="footer-col-wrapper">
      <div class="footer-col  footer-col-1">
        <ul class="contact-list">
          ...
          <li><a href="mailto:hectorivanapatriciomoreno@gmail.com">hectorivanapatriciomoreno@gmail.com</a></li>
        </ul>
      </div>
      ...
      <div class="footer-col  footer-col-3">
        <p class="text">Libro Eloquent JavaScript por Marijn Haverbeke
</p>
      </div>
    </div>
